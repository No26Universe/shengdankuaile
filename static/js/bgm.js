window.onload=function(){
	...
	if(localStorage.getItem('bgm_gds')!=null){
		...
		bgm.innerHTML='<source src="/static/bgm/'+localStorage.getItem('bgm_gds')+'.mp3" type="audio/mpeg">';
	}else{
		bgm.setAttribute('value',1);
		bgm.innerHTML='<source src="/static/bgm/1.mp3" type="audio/mpeg">';
	}
	//下一首
	bgm_btn_next.onclick=function(){
		...
		bgm.innerHTML='<source src="/static/bgm/'+bgm_gds+'.mp3" type="audio/mpeg">';
		bgm.load();
		bgm.play();
